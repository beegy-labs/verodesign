...
export function generateTypography(flat) {
  ...
  // Tabular + lining numerals — for numeric tables, monetary values, vote
  // counts, anywhere column alignment matters (모든 숫자 동일 폭).
  rules.push(
    `.vds-tabular-nums { font-feature-settings: "tnum" 1, "lnum" 1; font-variant-numeric: tabular-nums lining-nums; }`,
  );
