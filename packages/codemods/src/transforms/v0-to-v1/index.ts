...
const JS_IMPORT_REWRITES = [
  { from: /from\s+['"]@verobee\/design\/css\/(.+?)['"]/g, to: (_m: string, p: string) => `from '@verobee/utilities/css/${p}'` },
  { from: /from\s+['"]@verobee\/design\/utilities\/(.+?)['"]/g, to: (_m: string, p: string) => `from '@verobee/utilities/css/${p}'` },
];
